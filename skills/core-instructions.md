...
## Purpose
This workspace contains the `# Copilot Agent Instructions for Datasphere CLI

## Purpose
This workspace contains the `core-instructions` agent, which translates natural language requests into validated SAP Datasphere CLI commands and executes them safely.

## Workspace Layout
| Path | Purpose |
|---|---|
| `.github/agents/core-instructions.agent.md` | Custom agent definition |
...
- "Delete space TESTSPACE"` agent, which translates natural language requests into validated SAP Datasphere CLI commands and executes them safely.
